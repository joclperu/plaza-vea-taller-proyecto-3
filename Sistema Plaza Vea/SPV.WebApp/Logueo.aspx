...
<script type="text/javascript" language="javascript" src="Library/JS/fc_FuncDisenho.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function fn_Validar() {
            ...
            var result = false;
            var User = document.getElementById('pnlLogueo_UserName');
            var Pwd = document.getElementById('pnlLogueo_Password');
        ...
        <table border='0' cellpadding="0" cellspacing="0" style="width: 100%; height: 650px">
            <tr align="center">
                <td align="center">
                    ...
                    <div id="fading" runat="server" style="position: absolute; left: 95px; top: 250px; width: 79%; height: 80px; background-color: Transparent; z-index: 1;">
                                            ...
                                            <table cellpadding="0" cellspacing="3" border="0" style="height: 100%; width: 100%">
                                                <tr style="height: 35px;">
                                                    ...
                                                    <td style="width: 230px;">
                                                        <asp:TextBox ID="UserName" runat="server" Width="100%" Height="15px" MaxLength="20"></asp:TextBox>
                                                ...
                                                <tr style="height: 15px; padding-bottom: 5px">
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="Password" runat="server" TextMode="Password" CssClass="texto" Width="100%" Height="15px" MaxLength="20"></asp:TextBox>
                                                        <%--    <asp:RequiredFieldValidator ID="PasswordRequired" runat="server" ControlToValidate="Password"
                                                            ValidationGroup="Logeo">*</asp:RequiredFieldValidator>--%>
                                                    </td>
                                                </tr>
                                                <tr style="height: 50px;" valign="top">
                                                    <td align="right" colspan="2">&nbsp;<asp:ImageButton ID="LoginButton" CommandName="Login" runat="server" OnClientClick="return fn_Validar();"
                                                        ImageUrl="~/Images/botones/Ingresar.gif"></asp:ImageButton>&nbsp;&nbsp;&nbsp;&nbsp;<br />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" colspan="2">
                                                        <asp:Label ID="FailureText" runat="server" EnableViewState="False" ForeColor="Red" Font-Size="15px" Font-Names="Arial"></asp:Label>&nbsp;
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
