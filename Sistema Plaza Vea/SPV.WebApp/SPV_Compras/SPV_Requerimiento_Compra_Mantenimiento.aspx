...
<%@ Language="C#" 
    ...
    CodeFile="SPV_Requerimiento_Compra_Mantenimiento.aspx.cs" 
    Inherits="SPV_Compras_SPV_Requerimiento_Compra_Mantenimiento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function Fc_ValidaCab() {
            if (fc_Trim(document.getElementById("<%=this.cboArea.ClientID %>_CboArea").value) == "") {
                mstrError += mstrDebeSeleccionar + "área.\n";
            }

            if (fc_Trim(document.getElementById("<%=this.cboSolicitante.ClientID %>_CboSolicitante").value) == "") {
                mstrError += mstrDebeSeleccionar + "solicitante.\n";
            }   
        ...
        function Fc_EliminarDet(){
            if (fc_Trim(document.getElementById("<%=this.TxhId_detalle_requerimiento_compra.ClientID %>").value) == "") {
        ...
        function Fc_ValidaEsperaJustificacion() {
            return confirm(mstrSeguroEsperaJustificacion);
        }

        function Fc_ValidaCotizado() {
            return confirm(mstrSeguroCotizado);
        }

        function Fc_ValidaEsperaCotizacion() {
            return confirm(mstrSeguroEsperaCotizacion);
        }
        ...
        function Fc_ValidaPendienteAprobacion() {
            return confirm(mstrSeguroPendienteAprobaciono);
        }
    </script>
    <asp:hiddenfield runat="server" id="TxhIdCabecera_requerimiento_compra" />
            ...
            <td style="width:100%" align="right">
                <table id="Table2" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td align="bottom">
                            <!--Cabecera-->
                            <asp:ImageButton ID="BtnEsperaJustificacion" runat="server" ImageUrl="~/Images/iconos/b-incidencia.png" ToolTip="ESPERA JUSTIFICACIÓN" Visible="false"
                                OnClientClick="javaScript:return Fc_ValidaEsperaJustificacion();" OnClick="BtnEsperaJustificacion_Click"
                                onmouseover="javascript:this.src='../Images/iconos/b-incidencia2.png'" onmouseout="javascript:this.src='../Images/iconos/b-incidencia.png'"/>

                            <asp:ImageButton ID="BtnEsperaCotizacion" runat="server" ImageUrl="~/Images/iconos/b-terminarorden.gif" ToolTip="ESPERA COTIZACIÓN" Visible="false"
                                OnClientClick="javaScript:return Fc_ValidaEsperaCotizacion();" OnClick="BtnEsperaCotizacion_Click"
                            ...
                            <asp:ImageButton ID="BtnCotizado" runat="server" ImageUrl="~/Images/iconos/b-registroterminado.gif" ToolTip="COTIZADO" Visible="false"
                                OnClientClick="javaScript:return Fc_ValidaCotizado();" OnClick="BtnCotizado_Click"
                                onmouseover="javascript:this.src='../Images/iconos/b-registroterminado2.gif'" onmouseout="javascript:this.src='../Images/iconos/b-registroterminado.gif'"/>
                           ...
                           <asp:ImageButton ID="BtnPendienteAprobacion" runat="server" ImageUrl="~/Images/iconos/b-cerrarincidencia.png" ToolTip="PENDIENTE APROBACIÓN" Visible="false"
                                OnClientClick="javaScript:return Fc_ValidaPendienteAprobacion();" OnClick="BtnPendienteAprobacion_Click"
                                onmouseover="javascript:this.src='../Images/iconos/b-cerrarincidencia2.png'" onmouseout="javascript:this.src='../Images/iconos/b-cerrarincidencia.png'"/>
                            ...
                            <asp:ImageButton ID="BtnGrabarCab" runat="server" ImageUrl="~/Images/iconos/b-guardar.gif" ToolTip="Grabar" Visible="false"
                                OnClientClick="javaScript:return Fc_ValidaCab();" OnClick="BtnGrabarCab_Click"
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr style="width: 100%">
            <td style="vertical-align: top; width: 100%;">
                <cc1:tabcontainer id="TabRequerimientoCompra" runat="server" activetabindex="0" CssClass="" OnActiveTabChanged="TabRequerimientoCompra_ActiveTabChanged" AutoPostBack="true" >
                        ...
                        <HeaderTemplate>
                            <table id="tblHeader0" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    ...
                                    <td class="TabCabeceraOff" onmouseover="javascript: onTabCabeceraOver('0');" onmouseout="javascript: onTabCabeceraOut('0');"><%= this.TipoAccion %> Requerimiento Compra</td>
                                            ...
                                            <contenttemplate>
                                                <table width="99%" cellpadding="2" cellspacing="1" border="0" class="cuerponuevo" style="margin-left:5px; margin-right:5px; margin-top:5px; height:70px;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:20%"><uc3:ComboArea Width="60%" ID="cboArea" runat="server" OnSelectedIndexChanged="cboArea_SelectedIndexChanged" AutoPostBack="true"/></td>
                                                        <td style="width:10%">Solicitante</td>
                                                        <td style="width:20%"><uc4:ComboSolicitante Width="60%" ID="cboSolicitante" runat="server" OnSelectedIndexChanged="cboSolicitante_SelectedIndexChanged"/></td>
                    ...
                    <cc1:TabPanel ID="TabDetalleRequerimientoCompra" runat="server" CssClass="">
                        <HeaderTemplate>
                            <table id="tblHeader1" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td><img id="img3" alt="" src="../Images/Tabs/tab-izq.gif" /></td>
                                    <td class="TabCabeceraOff" onmouseover="javascript: onTabCabeceraOver('1');" onmouseout="javascript: onTabCabeceraOut('1');">Detalle Requerimiento Compra</td>
                                            ...
                                            <tr>
                                                <td valign="top" style="padding-top:15px;">
                                                    <asp:UpdatePanel ID="upMantenimiento" runat="server">
                                                        <contenttemplate>
                                                            <asp:hiddenfield runat="server" id="TxhId_detalle_requerimiento_compra" />
                                                           <asp:GridView id="GrwData" runat="server" SkinID="Grilla" Width="100%" OnRowDataBound="GrwData_RowDataBound" 
                                                                OnPageIndexChanging="GrwData_PageIndexChanging" DataKeyNames="id_detalle_requerimiento_compra" AutoGenerateColumns="False" 
                                                                AllowPaging="True" AllowSorting="True" OnSorting="GrwData_Sorting">
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="Proveedor" SortExpression="de_proveedor">
                                                                            <ItemStyle Width="20%" horizontalalign="left"/>
                                                                        <HeaderStyle Width="20%" />
                                                                        <ItemTemplate>
                                                                            <%# ((DetalleRequerimientoCompraBE)Container.DataItem).de_proveedor%>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField> 
                                                                    <asp:TemplateField HeaderText="Producto" SortExpression="de_producto">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <%# ((DetalleRequerimientoCompraBE)Container.DataItem).de_producto%>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Cantidad" SortExpression="va_cantidad">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <%# ((DetalleRequerimientoCompraBE)Container.DataItem).va_cantidad%>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField> 
                                                                    <asp:TemplateField HeaderText="Estado" SortExpression="de_estado">
                                                                        ...
                                                                        <HeaderStyle Width="10%" />
                                                                        <ItemTemplate>
                                                                            <%# ((DetalleRequerimientoCompraBE)Container.DataItem).de_estado%>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>                                                                    
                                                                </Columns>
                                                            </asp:GridView>
